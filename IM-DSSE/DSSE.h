...
private:
    prng_state prng;
    int scanDatabase(vector<string> &rFileNames,
    ...
    int createKeyword_file_pair(vector<vector<TYPE_INDEX>> &kw_file_pair,
                                TYPE_GOOGLE_DENSE_HASH_MAP &rT_W,
                                TYPE_GOOGLE_DENSE_HASH_MAP &rT_F,
...
public:
    ...
    int updateBlock(MatrixType *updating_block, MatrixType *input_block, TYPE_INDEX update_idx);

    int getBlock(TYPE_INDEX index, int dim, MatrixType **I, MatrixType *I_prime);
