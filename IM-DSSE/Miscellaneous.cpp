...
void Miscellaneous::print_ucharstring(const unsigned char *pInput, int in_len)
{
    int indx;
...
int Miscellaneous::ucarray_to_int(int &rDestination, unsigned char *pSource, int source_length)
{
...
int Miscellaneous::ucarray_to_ulong(unsigned long &rDestination, unsigned char *pSource, int source_length)
{
...
int Miscellaneous::longint_to_ucarray(unsigned char *pDestination, int destination_length, TYPE_INDEX *pSource)
{
...
int Miscellaneous::prepare_initial_counter(unsigned char *pInitialCounter, int size, TYPE_INDEX *pSource)
{
    int indx = 0;
    unsigned char tmp;
...
int Miscellaneous::print_file_names(string file_names[], int size)
{
    int indx = 0;
    if(!file_names->empty())
    {
...
int Miscellaneous::print_matrix_row(MatrixType **I, int row, TYPE_INDEX col_size)
{
...
int Miscellaneous::print_matrix_column(MatrixType **I, int col)
{
...
int Miscellaneous::read_file_cpp(unsigned char *pInData, int in_len, string file_name)
{
    ifstream file_stream;
    file_stream.open(file_name.c_str(), ios::in);
...
int Miscellaneous::write_file_cpp(string file_name, unsigned char *pOutData, int out_len)
{
...
int Miscellaneous::extract_file_names_with_path(vector<string> &rFileNames, string path)
{
    DIR *pDir;
...
int Miscellaneous::extract_file_names(vector<string> &rFileNames, string path)
{
    DIR *pDir;
    struct dirent *pEntry;
...
int Miscellaneous::read_single_block_from_file(string filename,
                                               string path,
                                               MatrixType **I,
                                               TYPE_INDEX num_row,
                                               TYPE_INDEX num_col,
...
int Miscellaneous::write_single_block_to_file(string filename,
                                              string path,
                                              MatrixType **I,
                                              TYPE_INDEX num_row,
                                              TYPE_INDEX num_col,
