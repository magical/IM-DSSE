    ...
    else
    {
        ...
        while(1)
        {
            ...
            case 1:
                ...
                cout << "BUILINDG TIME: " << std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count()
                     << " ms" << endl;
                break;
            case 2:
                // str_keyword = "the";
            ...
            case 4:
                ...
                cout << "TOTAL UPDATE TIME: " << std::chrono::duration_cast<std::chrono::nanoseconds>(end - start)
                                                         .count() << " ms" << endl;
